...
#sudo pacman -S --needed --noconfirm hyprland kitty firefox waybar hyprpolkitagent hyprpaper dunst nemo xdg-desktop-portal-hyprland wl-clipboard
...
# cliphist: é um clipboard, legal instalar o 'xdg-utils', ja instala o 'wl-clipboard'
# Code: vscode opensource, usar ele pois vou migrar depois para o nvim
# ZSH : shell, usar com Starship
# network-manager-applet  ?
# fastfetch : ver o sistema menorrr
# hyprpolkitagent: permissões administrativas no meio da tela
